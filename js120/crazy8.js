...
// how could we go about making a game that works with multiple players?
// Let me know how the refactor goes.
...
class PlayerCPU {
  ...
  takeTurn(pile, deck, game) {
    ...
    while (matches.length === 0) {
      console.log(`\n\n\n\nTHE COMPUTER DID NOT HAVE ANY CARDS that matched ${pile.centerCard}.\n\n\n\n`)
...
class CrazyEights {
  ...
  displayTable() {
    ...
    console.log(`${this.pile.centerCard}`)
  ...
  detectWinner() {
     return (this.cpu1.isEmpty()||this.human.isEmpty() )
  }
